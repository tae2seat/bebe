...
export default function Icon() {
    ...
    <div key={icon.name} className='flex flex-col justify-center items-center gap-1  w-28 h-28 p-2 bg-slate-100 rounded-full transition-transform hover:scale-110 cursor-pointer'>
