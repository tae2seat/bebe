    ...
    return (
        <div className='h-full text-cneter '>
            <div className='flex justify-center items-center'>
                <video width="full" height="720" autoPlay muted={false} ref={videoRef} onEnded={handleVideoEnded} className='rounded-lg'>
                    <source src={'/videos/video.mp4'} type='video/mp4' />
                </video>
            </div>
            <div className='flex justify-center items-center py-8'>
                <h1 className='text-center text-5xl font-semibold mt-20' >아이의 첫 시작을 Bebe가 응원합니다.</h1>
            </div>
            <div className='text-center py-16 leading-normal'>
                <h1 className=' text-3xl py-4'>About Bebekit</h1>
                <span className=' text-red-400 text-xl leading-normal'>"Bebekit"</span>
                <span className='text-xl leading-normal'>는 산모와 아이에게 필요한 용품과 정보가 20가지 들어있는 상자이자 브랜드 그 자체를 의미합니다.</span>
                <p className='text-xl leading-normal'>우리는 도움이 필요한 곳에 베베키트를 전달함으로써 아기에게 최소한의 환경을마련해주며, 세상에 내딛느 첫 걸음을 지지해주고 응원해주는 사회적 브랜드로 나아가고자 합니다.</p>
            </div> 
